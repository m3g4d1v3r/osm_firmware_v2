...
target_include_directories(application PUBLIC
    $ENV{OSM_MODEL_DIR}/pp01b/main
    $ENV{OSM_DIR}/include/osm/ports/rp2040
    $ENV{OSM_DIR}/include
)

set_target_properties(application
    PROPERTIES PICO_TARGET_LINKER_SCRIPT $ENV{OSM_DIR}/src/ports/rp2040/rp2040.ld
)

add_executable(bootloader
    $ENV{OSM_DIR}/src/ports/rp2040/bootloader/bootloader.c
)
...
target_include_directories(bootloader PUBLIC
    $ENV{OSM_DIR}/src/ports/rp2040/bootloader
    $ENV{OSM_MODEL_DIR}/pp01b/main
    $ENV{OSM_DIR}/include/osm/ports/rp2040
    $ENV{OSM_DIR}/include
)
...
set_target_properties(bootloader
    PROPERTIES PICO_TARGET_LINKER_SCRIPT $ENV{OSM_DIR}/src/ports/rp2040/bootloader/rp2040_bootloader.ld
)
...
add_custom_target(firmware ALL
    COMMAND
        ...
        ${picotool_INSTALL_DIR}/picotool/picotool uf2 convert firmware.bin firmware.uf2 --family rp2040 --abs-block

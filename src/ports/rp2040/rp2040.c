...
static bool _rp2040_persist_commit2(uint8_t* dst, uint8_t* src, uint32_t size)
{
...
bool osm_platform_persist_commit(osm_persist_storage_t* persist_data, osm_persist_measurements_storage_t* persist_measurements)
{
    ...
    bool ret = (_rp2040_persist_commit2(PERSIST_RAW_DATA, (uint8_t*)persist_data, sizeof(osm_persist_storage_t)) &&
        (_rp2040_persist_commit2(PERSIST_RAW_MEASUREMENTS, (uint8_t*)persist_measurements, sizeof(osm_persist_measurements_storage_t))));
